...
export default function ProfileCard({ type = "loading", user, }) {
    ...
    return <div className="p-5 border-t border-gray-100 shrink-0">
        <Link
            to="/account"
            className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-300 transition-all group shadow-sm"
        >
            {avatarUrl ? (
                <img
                    src={avatarUrl}
