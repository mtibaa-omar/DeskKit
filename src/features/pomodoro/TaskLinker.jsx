...
export function TaskLinker({
  ...
  if (activeRunTaskId && activeTask) {
    return (
      <div className="min-w-[160px] max-w-[160px] flex items-center gap-2 px-4 py-2 backdrop-blur-sm border border-black-100 rounded-xl text-black-700">
  ...
  if (linkedTaskId && linkedTaskTitle) {
    return (
      <div className="min-w-[160px] max-w-[160px] flex items-center gap-2 px-4 py-2 bg-gray-50 border border-black-100 rounded-xl text-black-700">
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        disabled={disabled}
        className="flex items-center min-w-[160px] max-w-[160px] gap-2 px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-white/50 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
